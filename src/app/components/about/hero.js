...
export default function Hero() {
  return (
    <div
      className=" bg-[#0d0e13] text-white h-screen-hero-home-custom relative flex flex-col justify-start mb-5 lg:mb-16
     "
    >
      <a
        href=""
      ...
      <div className="container max-w-screen-xl 2xl:max-w-screen-2xl mx-auto">
        ...
        <div className="py-10  2xl:pt-32 space-y-10 lg:space-y-0">
          ...
          >
            “Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum <br /> Lorem ipsum
      ...
      <div className="border-t-2 border-[#777777] lg:absolute lg:bottom-0 w-full py-5">
        <div
        ...
        >
          ...
          <a
            href="#first-section"
            className="text-sm leading-[18px] tracking-[-0.19px] lg:text-lg lg:leading-[22px] lg:tracking-[-0.22px] text-[#9c9b9b] border-b border-transparent hover:border-[#9c9b9b] transition-all duration-300 ease-in-out"
          >
            Scroll to explore
          </a>
        </div>
